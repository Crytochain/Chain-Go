...
var ErrVersion = errors.New("LBR version error")
 ...
 */
func LBREncode(data []byte, prefix byte) string {
 ...
 */
func LBRDecode(input string) (result []byte, version byte, err error) {
...
// func CheckLBRVersion(input byte) bool {
// 	return input == versionLBR
// }
