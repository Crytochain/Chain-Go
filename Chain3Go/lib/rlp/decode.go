...
// For field to be nill, should be able to escape
...
func (s *Stream) Decode(val interface{}) error {
	...
	rtyp := rval.Type()
	// fmt.Printf("Stream Decode Type %v: %s\n", rtyp.Name(), rval.String())
