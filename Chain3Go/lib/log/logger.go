...
func (l *logger) Debugf(msg string, a ...interface{}) {
	if a == nil {
		l.write(msg, LvlDebug, nil)
	} else {
		msgString := fmt.Sprintf(msg, a ...)
		l.write(msgString, LvlDebug, nil)
	}
}
...
func (l *logger) Infof(msg string, a ...interface{}) {
	if a == nil {
		l.write(msg, LvlInfo, nil)
	} else {
		msgString := fmt.Sprintf(msg, a ...)
		l.write(msgString, LvlInfo, nil)
	}
}
...
func (l *logger) Errorf(msg string, a ...interface{}) {
	if a == nil {
		l.write(msg, LvlError, nil)
	} else {
		msgString := fmt.Sprintf(msg, a ...)
		l.write(msgString, LvlError, nil)
	}
}
